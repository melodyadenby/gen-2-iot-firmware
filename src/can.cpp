...
void emergencyMCP2515Reset() {
  Serial.println("=== EMERGENCY MCP2515 RESET ===");
  ...
  extern volatile bool interruptFloodDetected;
  extern volatile int interruptFloodCount;
  extern volatile bool CAN_ERROR;
  extern volatile bool can_recovery_needed;
  ...
  // Force hardware reset of MCP2515
  mcp2515.reset();
  delay(100);
